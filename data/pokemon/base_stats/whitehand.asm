	...
	INCBIN "gfx/pokemon/front/whitehand.pic", 0, 1 ; sprite dimensions
	dw WhiteHandPicFront, WhiteHandPicBack
	...
	assert BANK(WhiteHandPicFront) == BANK(WhiteHandPicBack)
